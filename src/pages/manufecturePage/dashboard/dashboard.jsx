...
import { overviewData, recentSalesData, deliveryProducts } from "@/constants";
import { useTheme } from "../../../hooks/use-theme";

const ManufectureDashboardPage=()=>{
    ...
    return (
        <div className="flex flex-col gap-y-4">
          ...
          <div className="card">
                    <div className="card-header">
                        ...
                        <p className="card-title">Total Delivered Products</p>
                    </div>
                ...
                <div className="card">
                    <div className="card-header">
                        ...
                        <p className="card-title">Total Delivered Cost</p>
                    </div>
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">$125,154</p>
                        <span className="flex w-fit items-center gap-x-2 rounded-full border border-blue-500 px-2 py-1 font-medium text-blue-500 dark:border-blue-600 dark:text-blue-600">
                            <TrendingUp size={18} />
                            42%
                        </span>
                ...
                <div className="card">
                    <div className="card-header">
                        ...
                        <p className="card-title">Today Deliverd</p>
                    </div>
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">25,154</p>
                        <span className="flex w-fit items-center gap-x-2 rounded-full border border-blue-500 px-2 py-1 font-medium text-blue-500 dark:border-blue-600 dark:text-blue-600">
                ...
                <div className="card">
                    <div className="card-header">
                        ...
                        <p className="card-title">Monthly Deliverd</p>
                    </div>
                    <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
                        <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">$25,154</p>
                        <span className="flex w-fit items-center gap-x-2 rounded-full border border-blue-500 px-2 py-1 font-medium text-blue-500 dark:border-blue-600 dark:text-blue-600">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-7">
            <div className="card col-span-1 md:col-span-2 lg:col-span-4">
                <div className="card-header">
                    <p className="card-title">Transaction Overview</p>
                </div>
                <div className="card-body p-0">
                 ...
                 <div className="card col-span-1 md:col-span-2 lg:col-span-3">
                    <div className="card-header justify-between">
                        <p className="card-title"> Today Delivery Status</p>
                            ...
                            <tbody className="table-body">
                                {deliveryProducts.map((product) => (
                                    ...
                                    >
                                        ...
                                        <td className="table-cell">{product.Destination}</td>
                                        <td className="table-cell">
...
export default ManufectureDashboardPage;